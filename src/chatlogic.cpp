...
ChatLogic::ChatLogic()
{
    ...
    /* Task 5 : ChatBot no longer created here
...
ChatLogic::~ChatLogic()
{
    ...
    // Task 5 : No longer needed since _ChatBot is not instantiated in the constructor.
    //delete _chatBot;

    /* 
    //Task 3: Uneeded since _nodes are smart poitners
    // delete all nodes
    ...
    // Unneeded since _edges is no longer used
    // delete all edges
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        //Task 3 : change to unique pointers
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            //Task 3 : use .get() since childNode is a unique pointers
    ...
    for (auto it = std::begin(_nodes); it != std::end(_nodes); ++it)
    {
        ...
        if ((*it)->GetNumberOfParents() == 0)
        {
            ...
            if (rootNode == nullptr)
            {
                //Task 3: Use .get() since it is a unique pointer (since _nodes was changed to unique pointers)
